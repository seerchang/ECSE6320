...
def compress(quality_jp=None, quality_jp2=None, quality_heif=None):
    ...
    for input_path in input_files:
        ...
        if quality_jp is not None:
            ...
            jpeg_recon = Image.open(jpeg_path)
            ...
            jpeg_gdm = gradient_difference_metric(original_img, jpeg_recon)
        ...
        if quality_jp2 is not None:
            ...
            jp2_gdm = gradient_difference_metric(original_img, jp2_recon)
        ...
        if quality_heif is not None:
            ...
            heif_recon = Image.open(heif_path)
            ...
            heif_gdm = gradient_difference_metric(original_img, heif_recon)
